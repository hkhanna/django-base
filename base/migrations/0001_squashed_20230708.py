...
class Migration(migrations.Migration):
    ...
    replaces = [('base', '0001_initial'), ('base', '0002_user_email_history'), ('base', '0003_emailmessage_reply_to'), ('base', '0004_auto_20220906_1822'), ('base', '0005_user_uuid'), ('base', '0006_auto_20221030_2351'), ('base', '0007_alter_user_uuid'), ('base', '0008_auto_20221101_1523'), ('base', '0009_auto_20221101_1605'), ('base', '0010_auto_20221101_1645'), ('base', '0011_orgs'), ('base', '0012_auto_20230317_2021'), ('base', '0013_emailmessage_org'), ('base', '0014_auto_20230322_0050'), ('base', '0015_auto_20230405_1957'), ('base', '0016_event')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_history', django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(max_length=254), blank=True, default=list, help_text='Record of all email addresses the user has had.', size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('ready', 'Ready'), ('pending', 'Pending'), ('sent', 'Sent'), ('delivered', 'Delivered'), ('opened', 'Opened'), ('bounced', 'Bounced'), ('spam', 'Spam'), ('canceled', 'Canceled'), ('error', 'Error')], default='new', max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_messages', models.ManyToManyField(related_name='org_invitations', to='base.EmailMessage')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
